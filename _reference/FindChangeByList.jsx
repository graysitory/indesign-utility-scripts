...
function myDisplayDialog(lstChoose){
	...
	if(myResult == true){
        ...
        // check what the user wants to apply changes to: selection, whole doc, etc.
...
//-------------------------------------------------------------------------
//-- Taken from: http://extendscript.blogspot.hu/2009/07/select-element-item-via-radio-buttons.html
//-------------------------------------------------------------------------
